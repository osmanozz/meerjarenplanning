...
<html lang="en">
    ...
    <body>
        ...
        if(is_array($dataset) && !empty($dataset)){ 
            ...
            <caption style="caption-side:top"><h2>Overzicht Vakken</h2></caption>
            ...
            <tr>
                ...
                <?php foreach($dataset as $rows=>$row){ 
                    ...
                    <!-- <td>
                        <a href="edit-alg-<?php echo $from?>.php&vak_code=<?php echo trim($row['vak_code']); ?>
                         ?>"
                        class="btn btn-primary" >Edit</a>
                    </td> -->
                    <td>
                        <a href="delete-alg-<?php echo $from?>.php?vak_code=<?php echo $row_id; ?>" class="btn btn-danger" >Delete</a>
                    </td>
                    </tr>
            <?php }
         }
